      ...
      <div className="container mx-auto px-4 md:px-6">
        <Card className="max-w-4xl mx-auto shadow-lg">
          ...
          <CardContent className="space-y-6 text-muted-foreground prose prose-lg max-w-none">
            ...
            <h2 className="text-xl font-semibold text-primary">Information Collection and Use</h2>
            <p>We collect several different types of information for various purposes to provide and improve our Service to you.</p>
            
            <h3 className="text-lg font-semibold text-primary">Types of Data Collected</h3>
