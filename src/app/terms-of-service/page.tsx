      ...
      <div className="container mx-auto px-4 md:px-6">
        <Card className="max-w-4xl mx-auto shadow-lg">
          ...
          <CardContent className="space-y-6 text-muted-foreground prose prose-lg max-w-none">
            {isClient ? <p>Last updated: {lastUpdated}</p> : <p>Last updated: ...</p>}
            ...
            <h2 className="text-xl font-semibold text-primary dark:text-primary-foreground">Accounts</h2>
            ...
            <h2 className="text-xl font-semibold text-primary dark:text-primary-foreground">Intellectual Property</h2>
            ...
            <h2 className="text-xl font-semibold text-primary dark:text-primary-foreground">Termination</h2>
            <p>We may terminate or suspend your account and bar access to the Service immediately, without prior notice or liability, under our sole discretion, for any reason whatsoever and without limitation, including but not limited to a breach of the Terms.</p>
            
            <h2 className="text-xl font-semibold text-primary dark:text-primary-foreground">Governing Law</h2>
            ...
            <h2 className="text-xl font-semibold text-primary dark:text-primary-foreground">Changes</h2>
