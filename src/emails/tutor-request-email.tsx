    ...
    <Body style={main}>
      <Container style={emailContainer}>
        ...
        <Section style={bodyContent}>
          ...
          <Text>The following user has submitted a request to find a tutor:</Text>
          <Section style={userDetails}>
            ...
            <Text style={detailItem}><strong>WhatsApp:</strong> {whatsapp}</Text>
            <Text style={detailItem}><strong>State:</strong> {state}</Text>
            <Text style={detailItem}><strong>Native Language:</strong> {language}</Text>
            <Text style={detailItem}><strong>Schedule Preference:</strong> {schedule}</Text>
          </Section>
        </Section>
